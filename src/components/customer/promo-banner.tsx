  ...
  return (
    <Link href="/app/restaurants" className="relative block overflow-hidden rounded-[2rem] bg-dalle-charcoal p-5 text-white shadow-glow">
      ...
      <div className="relative flex items-center justify-between gap-4">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-black text-dalle-lime"><Flame size={14} /> Promo vibe</span>
          <h2 className="mt-3 text-2xl font-black">-20% sur ta première commande</h2>
          <p className="mt-1 text-sm text-white/70">Choisis ton resto, on gère la dalle.</p>
        </div>
