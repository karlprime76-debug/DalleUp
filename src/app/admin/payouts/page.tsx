...
export default function AdminPayoutsPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Demandes de retrait</h1>
                  ...
                  <td className="p-3 text-right">
                    {p.status === "REQUESTED" && (
                      <button
                        ...
                        className="bg-green-600 text-white px-3 py-1 rounded text-xs font-medium hover:bg-green-700 disabled:bg-gray-300"
                      >
