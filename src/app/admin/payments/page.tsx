...
const nav = [{ href: "/admin", label: "Accueil" }, { href: "/admin/orders", label: "Commandes" }, { href: "/admin/restaurants", label: "Restaurants" }, { href: "/admin/payments", label: "Paiements" }, { href: "/admin/audit", label: "Audit" }, { href: "/admin/compliance", label: "Conformité" }];
