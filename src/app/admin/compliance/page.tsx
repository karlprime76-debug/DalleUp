...
const nav = [{ href: "/admin", label: "Accueil" }, { href: "/admin/payments", label: "Paiements" }, { href: "/admin/audit", label: "Audit" }, { href: "/admin/notifications", label: "Notifications" }, { href: "/admin/compliance", label: "Conformité" }];
