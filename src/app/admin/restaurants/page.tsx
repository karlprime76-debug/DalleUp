...
const nav = [{ href: "/admin", label: "Accueil" }, { href: "/admin/orders", label: "Commandes" }, { href: "/admin/restaurants", label: "Restaurants" }, { href: "/admin/settings", label: "Paramètres" }];
