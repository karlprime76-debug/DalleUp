...
export default async function RestaurantDetailsPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams?: Promise<{ item?: string }> }) {
