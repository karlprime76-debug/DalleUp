  ...
  return (
    <main className="px-4 py-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-5 flex gap-2 overflow-x-auto pb-2">{categories.map((category, index) => <Badge key={category} variant={index === 0 ? "dark" : "soft"} className="shrink-0">{category}</Badge>)}</div>
